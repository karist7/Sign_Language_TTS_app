...
class PoseLandmarkerHelper(
    ...
    fun setupPoseLandmarker() {
        ...
        try {
            ...
            poseLandmarkerHelperListener?.onError2(
                "1Pose Landmarker failed to initialize. See error logs for " +
                        "details"
            )
            Log.e(
            ...
            poseLandmarkerHelperListener?.onError2(
                "2Pose Landmarker failed to initialize. See error logs for " +
                        "details", GPU_ERROR
            )
            Log.e(
                TAG,
    ...
    private fun returnLivestreamResult(
        ...
        poseLandmarkerHelperListener?.onResults2(
            ResultBundle(
                listOf(result),
                inferenceTime,
                input.height,
    ...
    interface LandmarkerListener {
        fun onError2(error: String, errorCode: Int = OTHER_ERROR)
        fun onResults2(resultBundle: ResultBundle)
    }
